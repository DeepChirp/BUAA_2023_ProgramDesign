# C2 - 2023级程序设计基础第二次上机赛

欢迎大家来到程序设计的世界里。

这是2023程序设计基础的第二次上机，相信经历过第一次上机和第一次练习赛洗礼的各位已经对OJ和编程有了初步的了解。在本次上机过程中，你可能需要以下知识才能较为轻松地完成本次的所有题目：
...
**本次上机的分数设置A题为30分，B题为20分，C-F题为10分，G~J题为5分，总分110分，超过100分记作100分。以后的上机分数设置可能会有不同，注意查看。**
